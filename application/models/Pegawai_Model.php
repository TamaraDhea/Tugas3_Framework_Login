...
class Pegawai_Model extends CI_Model {
		...
		{
			$object = array('nama' => $this->input->post('nama'),'nip' => $this->input->post('nip'),'tanggalLahir' => $this->input->post('tanggalLahir'), 'alamat' => $this->input->post('alamat'), 'foto' => $this->upload->data('file_name'),);
		...
		{
			$data = array('nama' => $this->input->post('nama'),'nip' => $this->input->post('nip'), 'tanggalLahir' => $this->input->post('tanggalLahir'), 'alamat' => $this->input->post('alamat'), 'foto' => $this->upload->data('file_name'),);
			$this->db->where('id', $id);
		...
		public function insertJabatanPegawai($idPegawai)
		{
			$object = array('namaJabatan' => $this->input->post('jabatan'), 'tanggalMulai' => $this->input->post('tanggalMulai'),'tanggalSelesai' => $this->input->post('tanggalSelesai'),'fk_pegawai' => $idPegawai);
		...
		public function deleteJabatan($idPegawai)
		{
