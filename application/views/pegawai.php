		...
		<div class="container-fluid">
				<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
							...
							<table class="table table-hover">
								...
								<?php foreach ($pegawai_list as $key) { ?>
									<tr>
										...
										<td><img src="<?=base_url()?>assets/uploads/<?=$key->foto ?>" width="50" height="50"></td>
										<td>
					...
					<div class="col-xs-11 col-sm-11 col-md-11 col-lg-11">
					 <center><a href="<?php echo site_url('pegawai/create') ?>"><button type="button" class="btn btn-danger">Tambah Data</button></center>
					</div>
